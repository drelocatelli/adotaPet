...
<!DOCTYPE html>
    ...
    <form class="form-horizontal" method="post" action="src/Authentication.php">
        <fieldset>
            <legend><?= $site['title']; ?> - Administração</legend>
            <br>
            <?php 
                session_start();
            ...
            <div class="form-group">
                <div class="col-md-12">
                    <input id="password" name="password" type="password" placeholder="******" class="form-control input-md" style="text-align:center;" required autofocus>
                </div>
                <div class="col-md-2">
                    <button class="btn btn-primary" style="display:none;" type="submit" name="submit">Entrar</button>
                </div>
            </div>
        </fieldset>
        </form>
